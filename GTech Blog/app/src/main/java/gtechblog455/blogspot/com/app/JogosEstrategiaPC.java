...
public class JogosEstrategiaPC extends ListActivity
{
	Uri a;
	MediaPlayer md;
	Intent dl;
	...
	String gpc1(){
		r = getResources().openRawResource(R.raw.gpc_estrategia_1);
	...
	protected void onListItemClick(ListView l, View v, int position, long id)
	{
		...
		md = MediaPlayer.create(JogosEstrategiaPC.this, R.raw.click_);
		md.start();
		if(lp.toString() == "League of Legends"){
			...
			bd.setPositiveButton("Baixar", new DialogInterface.OnClickListener(){
					public void onClick(DialogInterface d, int vi){
						MediaPlayer md = MediaPlayer.create(JogosEstrategiaPC.this, R.raw.click_);
						md.start();
						a = a.parse("http://m.baixaki.com.br/download/league-of-legends.htm");
			...
			bd.setNegativeButton("Cancelar", new DialogInterface.OnClickListener(){
					public void onClick(DialogInterface d, int vu){
						MediaPlayer md = MediaPlayer.create(JogosEstrategiaPC.this, R.raw.click_);
						md.start();
						Toast.makeText(JogosEstrategiaPC.this, "Instalacao de " + lp + " Cancelada!!", Toast.LENGTH_LONG).show();
					}
				});
			bd.create();
			bd.show();
